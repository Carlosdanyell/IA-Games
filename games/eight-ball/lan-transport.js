...
// Uma sala = um RTCPeerConnection e um DataChannel confiável/ordenado.
// Não há descoberta de IP, servidor externo, microfone nem câmera.
export class LanTransport {
  ...
  async createOffer() {
    ...
    this.bind(pc.createDataChannel('neon-pool-v1', { ordered: true }));
